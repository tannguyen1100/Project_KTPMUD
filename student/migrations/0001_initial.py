    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('giua_ki', models.FloatField(blank=True, null=True, validators=[student.validators.validate_score])),
                ('cuoi_ki', models.FloatField(blank=True, null=True, validators=[student.validators.validate_score])),
